window.onload = function () {
    ...
    function checkWin(winner) {
        if (winner.color == "red") {
            if (r1.isReachedDestination && r2.isReachedDestination && r3.isReachedDestination && r4.isReachedDestination) {
            ...
            if ((y1.isReachedDestination && y2.isReachedDestination && y3.isReachedDestination && y4.isReachedDestination) || redAutoExit) {
                document.getElementById("finalnotep").innerHTML = "Farhad Rahmani Won"; document.getElementById("finalnote").style.display = "block";
            }
        }
    }
    ...
    alert("This is Developer Test App  🔥🔥🔥");


    var newRule = confirm("Farhad Rahmani: You can Just Play it Now for Test Purpose  🔥🔥🔥");
